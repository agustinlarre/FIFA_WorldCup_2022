...
namespace Dominio
{
    public class Sistema
    {
        ...
        private List<Resenia> Resenias { get;}
        ...
        private void PrecargarDatos()
        {
            ...
            /*PARTIDOS*/
            #region Partidos fase de grupos
            #region Grupo H
            FaseDeGrupos grupoH1 = new FaseDeGrupos("H", GetSeleccion("Uruguay"), GetSeleccion("Portugal"), new DateTime(2022, 11, 28, 16, 0, 0), false, "Pendiente");
            AltaPartido(grupoH1);
            Incidencia i1 = new Incidencia(10, "Amarilla", GetJugador("Edinson Cavani"));
            Incidencia i2 = new Incidencia(30, "Gol", GetJugador("Luis Suárez"));
            Incidencia i3 = new Incidencia(70, "Roja", GetJugador("Bruno Fernandes"));
            grupoH1.AddIncidencia(i1);
            grupoH1.AddIncidencia(i2);
            grupoH1.AddIncidencia(i3);
            grupoH1.ResultadoDelPartido = grupoH1.CalcularResultado();
            grupoH1.Finalizado = true;

            FaseDeGrupos grupoH2 = new FaseDeGrupos("H", GetSeleccion("Uruguay"), GetSeleccion("Ghana"), new DateTime(2022, 12, 02, 12, 0, 0), false, "Pendiente");
            AltaPartido(grupoH2);
            Incidencia i4 = new Incidencia(10, "Amarilla", GetJugador("Edinson Cavani"));
            Incidencia i5 = new Incidencia(90, "Gol", GetJugador("Facundo Pellistri"));
            Incidencia i6 = new Incidencia(93, "Roja", GetJugador("Kwasi Wriedt"));
            grupoH2.AddIncidencia(i4);
            grupoH2.AddIncidencia(i5);
            grupoH2.AddIncidencia(i6);
            grupoH2.ResultadoDelPartido = grupoH2.CalcularResultado();
            grupoH2.Finalizado = true;

            FaseDeGrupos grupoH3 = new FaseDeGrupos("H", GetSeleccion("Uruguay"), GetSeleccion("Corea del Sur"), new DateTime(2022, 11, 24, 10, 0, 0), false, "Pendiente");
            AltaPartido(grupoH3);
            Incidencia i7 = new Incidencia(4, "Gol", GetJugador("Darwin Núñez"));
            Incidencia i8 = new Incidencia(45, "Amarilla", GetJugador("Moon-hwan Kim"));
            Incidencia i9 = new Incidencia(54, "Roja", GetJugador("Moon-hwan Kim"));
            grupoH3.AddIncidencia(i7);
            grupoH3.AddIncidencia(i8);


            FaseDeGrupos grupoH4 = new FaseDeGrupos("H", GetSeleccion("Portugal"), GetSeleccion("Corea del Sur"), new DateTime(2022, 11, 24, 10, 0, 0), false, "Pendiente");
            AltaPartido(grupoH4);
            Incidencia i10 = new Incidencia(4, "Amarilla", GetJugador("Hyeon-woo Jo"));
            Incidencia i11 = new Incidencia(57, "Roja", GetJugador("Dong-hyeon Kim"));
            Incidencia i12 = new Incidencia(78, "Gol", GetJugador("Bruno Fernandes"));
            grupoH4.AddIncidencia(i10);
            grupoH4.AddIncidencia(i11);
            grupoH4.AddIncidencia(i12);


            FaseDeGrupos grupoH5 = new FaseDeGrupos("H", GetSeleccion("Portugal"), GetSeleccion("Ghana"), new DateTime(2022, 11, 24, 10, 0, 0), false, "Pendiente");
            AltaPartido(grupoH5);
            Incidencia i13 = new Incidencia(1, "Amarilla", GetJugador("Pepe"));
            Incidencia i14 = new Incidencia(57, "Roja", GetJugador("Pepe"));
            Incidencia i15 = new Incidencia(78, "Gol", GetJugador("Diogo Jota"));
            grupoH5.AddIncidencia(i13);
            grupoH5.AddIncidencia(i14);
            grupoH5.AddIncidencia(i15);


            FaseDeGrupos grupoH6 = new FaseDeGrupos("H", GetSeleccion("Corea del Sur"), GetSeleccion("Ghana"), new DateTime(2022, 11, 24, 10, 0, 0), false, "Pendiente");
            AltaPartido(grupoH6);
            Incidencia i17 = new Incidencia(12, "Roja", GetJugador("André Ayew"));
            Incidencia i18 = new Incidencia(30, "Amarilla", GetJugador("Hyeon-woo Jo"));
            Incidencia i19 = new Incidencia(89, "Gol", GetJugador("Ji-soo Park"));
            grupoH6.AddIncidencia(i17);
            grupoH6.AddIncidencia(i18);
            grupoH6.AddIncidencia(i19);
            #endregion

            #region Grupo A
            FaseDeGrupos grupoA1 = new FaseDeGrupos("A", GetSeleccion("Catar"), GetSeleccion("Ecuador"), new DateTime(2022, 11, 20, 13, 0, 0), false, "Pendiente");
            AltaPartido(grupoA1);
            Incidencia i20 = new Incidencia(20, "Amarilla", GetJugador("Byron Castillo"));
            Incidencia i21 = new Incidencia(25, "Roja", GetJugador("Byron Castillo"));
            Incidencia i22 = new Incidencia(32, "Gol", GetJugador("Enner Valencia"));
            grupoA1.AddIncidencia(i20);
            grupoA1.AddIncidencia(i21);
            grupoA1.AddIncidencia(i22);
            grupoA1.ResultadoDelPartido = grupoA1.CalcularResultado();
            grupoA1.Finalizado = true;

            FaseDeGrupos grupoA2 = new FaseDeGrupos("A", GetSeleccion("Catar"), GetSeleccion("Senegal"), new DateTime(2022, 11, 25, 10, 0, 0), false, "Pendiente");
            AltaPartido(grupoA2);
            Incidencia i23 = new Incidencia(75, "Gol", GetJugador("Abdou Diallo"));
            Incidencia i24 = new Incidencia(80, "Amarilla", GetJugador("Ali Asad"));
            Incidencia i25 = new Incidencia(92, "Roja", GetJugador("Almoez Ali"));
            grupoA2.AddIncidencia(i23);
            grupoA2.AddIncidencia(i24);
            grupoA2.AddIncidencia(i25);

            FaseDeGrupos grupoA3 = new FaseDeGrupos("A", GetSeleccion("Catar"), GetSeleccion("Países Bajos"), new DateTime(2022, 11, 29, 12, 0, 0), false, "Pendiente");
            AltaPartido(grupoA3);
            Incidencia i26 = new Incidencia(15, "Roja", GetJugador("Ali Asad"));
            Incidencia i27 = new Incidencia(85, "Amarilla", GetJugador("Memphis Depay"));
            Incidencia i28 = new Incidencia(87, "Gol", GetJugador("Memphis Depay"));
            grupoA3.AddIncidencia(i26);
            grupoA3.AddIncidencia(i27);
            grupoA3.AddIncidencia(i28);

            FaseDeGrupos grupoA4 = new FaseDeGrupos("A", GetSeleccion("Ecuador"), GetSeleccion("Países Bajos"), new DateTime(2022, 11, 25, 13, 0, 0), false, "Pendiente");
            AltaPartido(grupoA4);
            Incidencia i29 = new Incidencia(2, "Amarilla", GetJugador("Carlos Gruezo"));
            Incidencia i30 = new Incidencia(5, "Roja", GetJugador("Félix Torres"));
            Incidencia i31 = new Incidencia(30, "Gol", GetJugador("Steven Bergwijn"));
            grupoA4.AddIncidencia(i29);
            grupoA4.AddIncidencia(i30);
            grupoA4.AddIncidencia(i31);

            FaseDeGrupos grupoA5 = new FaseDeGrupos("A", GetSeleccion("Senegal"), GetSeleccion("Países Bajos"), new DateTime(2022, 11, 21, 13, 0, 0), false, "Pendiente");
            AltaPartido(grupoA5);
            Incidencia i32 = new Incidencia(2, "Amarilla", GetJugador("Sadio Mané"));
            Incidencia i33 = new Incidencia(40, "Gol", GetJugador("Memphis Depay"));
            Incidencia i34 = new Incidencia(56, "Roja", GetJugador("Boulaye Dia"));
            grupoA5.AddIncidencia(i32);
            grupoA5.AddIncidencia(i33);
            grupoA5.AddIncidencia(i34);

            FaseDeGrupos grupoA6 = new FaseDeGrupos("A", GetSeleccion("Senegal"), GetSeleccion("Ecuador"), new DateTime(2022, 11, 21, 13, 0, 0), false, "Pendiente");
            AltaPartido(grupoA6);
            Incidencia i35 = new Incidencia(7, "Amarilla", GetJugador("Pape Gueye"));
            Incidencia i36 = new Incidencia(20, "Gol", GetJugador("Sadio Mané"));
            Incidencia i37 = new Incidencia(56, "Roja", GetJugador("Pervis Estupiñán"));
            grupoA6.AddIncidencia(i35);
            grupoA6.AddIncidencia(i36);
            grupoA6.AddIncidencia(i37);
            #endregion
            #endregion

            #region Partidos fase eliminatoria
            FaseEliminatoria octavos1 = new FaseEliminatoria(true, false, Etapa.Octavos, GetSeleccion("Uruguay"), GetSeleccion("Países Bajos"), new DateTime(2022, 11, 30, 15, 0, 0), false, "Pendiente");
            AltaPartido(octavos1);
            Incidencia ei1 = new Incidencia(10, "Gol", GetJugador("Facundo Pellistri"));
            Incidencia ei2 = new Incidencia(60, "Roja", GetJugador("Steven Bergwijn"));
            Incidencia ei3 = new Incidencia(90, "Gol", GetJugador("Memphis Depay"));
            Incidencia ei4 = new Incidencia(107, "Gol", GetJugador("Luis Suárez"));
            octavos1.AddIncidencia(ei1);
            octavos1.AddIncidencia(ei2);
            octavos1.AddIncidencia(ei3);
            octavos1.AddIncidencia(ei4);

            FaseEliminatoria octavos2 = new FaseEliminatoria(false, false, Etapa.Octavos, GetSeleccion("Senegal"), GetSeleccion("Portugal"), new DateTime(2022, 12, 3, 13, 0, 0), false, "Pendiente");
            AltaPartido(octavos2);
            Incidencia ei5 = new Incidencia(30, "Amarilla", GetJugador("Abdou Diallo"));
            Incidencia ei6 = new Incidencia(88, "Gol", GetJugador("Sadio Mané"));
            octavos2.AddIncidencia(ei5);
            octavos2.AddIncidencia(ei6);

            FaseEliminatoria cuartos1 = new FaseEliminatoria(false, false, Etapa.Cuartos, GetSeleccion("Uruguay"), GetSeleccion("Senegal"), new DateTime(2022, 12, 4, 16, 0, 0), false, "Pendiente");
            AltaPartido(cuartos1);
            Incidencia ei7 = new Incidencia(30, "Roja", GetJugador("Facundo Pellistri"));
            Incidencia ei8 = new Incidencia(88, "Amarilla", GetJugador("Sadio Mané"));
            Incidencia ei9 = new Incidencia(90, "Gol", GetJugador("Luis Suárez"));
            cuartos1.AddIncidencia(ei7);
            cuartos1.AddIncidencia(ei8);
            cuartos1.AddIncidencia(ei9);
            #endregion

            /*PERIODISTAS*/
            #region Precarga de periodista
            Periodista pe1 = new Periodista("Jorge", "Pérez", "jorgitoBolso@gmail.com", "JorgeBolso123");
            AltaUsuario(pe1);
            Periodista pe2 = new Periodista("Juan", "Pérez", "juanManya@gmail.com", "JuanManya123");
            AltaUsuario(pe2);
            #endregion

            /*OPERADORES*/
            #region Precarga de operadores
            Operador op1 = new Operador("Agustín", "Larre Borges", "agustin@gmail.com", "Agustin123", new DateTime(2022, 02, 05, 0, 0, 0));
            AltaUsuario(op1);
            Operador op2 = new Operador("Marcelo", "Gestido", "marcelo@gmail.com", "Marcelo123", new DateTime(2022, 01, 20, 0, 0, 0));
            AltaUsuario(op2);
            #endregion

            /*RESENIAS*/
            #region Resenias
            Resenia re1 = new Resenia(pe2, new DateTime(2022, 12, 01, 0, 0, 0), grupoH1, "El retorno del pistlero", "Frente a las dudas de la mayoría de los espectadores, Luis Suarez supo estar a la altura y brindarle a la selección uruguaya la victoria frente a Portugal.");
            AltaResenia(re1);
            Resenia re2 = new Resenia(pe1, new DateTime(2022, 12, 02, 0, 0, 0), grupoH2, "Una nueva joya conquista territorio africano", "Con un formidable gol de Facundo Pellistri, Uruguay supera al equipo ghanés, acumulando dos victorias en el mundial Qatar 2022.");
            AltaResenia(re2);
            #endregion
        }

        /// <summary>
        /// Metodo para precargar selecciones
        /// </summary>
        ...
        private List<Jugador> JugadoresDe(Pais p)
        {
            ...
            foreach (Jugador j in Jugadores)
            {
                ...
                if (j.UnPais.Nombre.Equals(p.Nombre))
                {
                    _misJugadores.Add(j);
                }
            }
        ...
        /// <summary>
        /// Retorna el objeto jugador a partir de pasar el nombre completo por parametros
        /// </summary>
        /// <param name="j"></param>
        /// <returns></returns>
        public Jugador GetJugador(string j)
        {
            foreach (Jugador unJugador in Jugadores)
            {
                if (j == unJugador.NombreCompleto)
                {
                    return unJugador;
                }
            }
        ...
        /// <summary>
        /// Permite dar de alta a un periodista u operados al sistema
        /// </summary>
        ...
        public void AltaUsuario(Usuario unUsuario)
        {
            try
            {
                ...
                {
                    throw new Exception("El usuario ya fue registrado con ese email");
                }
            }
            catch (Exception e)
            {
        ...
        /// <summary>
        /// Retorna lista de reseñas de los periodistas
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Retorna la reseña buscada por id
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Permite dar de alta una reseña luego de validada
        /// </summary>
        /// <param name="unaResenia"></param>
        public void AltaResenia(Resenia unaResenia)
        {
            try
            {
                unaResenia.Validar();
                Resenias.Add(unaResenia);
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Permite agregar una nueva seleccion a la lista de selecciones
        /// </summary>
        /// <param name="unaSeleccion"></param>
        public void AltaSeleccion(Seleccion unaSeleccion)
        {
            try
            {
                if (!Selecciones.Contains(unaSeleccion))
                {
                    unaSeleccion.Validar();
                    Selecciones.Add(unaSeleccion);
                }
                else 
                {
                    throw new Exception("Seleccion ya existente");
                }
            }
            catch (Exception exc)
            {
        ...
        /// <summary>
        /// Retorna el objeto Seleccion a partir de pasar el nombre del pais por parametro
        /// </summary>
        /// <param name="s"></param>
        /// <returns></returns>
        public Seleccion GetSeleccion(string s)
        {
            foreach (Seleccion unaSeleccion in Selecciones)
            {
                if (s.ToLower() == unaSeleccion.UnPais.Nombre.ToLower())
                {
                    return unaSeleccion;
                }
            }
        ...
        /// <summary>
        /// Agrega un pais a la lista con su correspondiente validacion
        /// </summary>
        /// <param name="unPais"></param>
        public void AltaPais(Pais unPais)
        {
            try
            {
                ...
                {
                    throw new Exception("Pais existente");
                }
            }
        ...
        public void AltaJugador(Jugador unJugador)
        {
            try
            {
                ...
                {
                    throw new Exception("Jugador ya agregado");
                }
            }
        ...
        /// <summary>
        /// Permite dar de alta un partido con su correspondiente validación
        /// </summary>
        /// <param name="unPartido"></param>
        public void AltaPartido(Partido unPartido)
        {
            try
            {
                if (!Partidos.Contains(unPartido))
                {
                    unPartido.Validar();
                ...
                {
                    throw new Exception("El partido ya fue creado");
                }
        ...
        /// <summary>
        /// Retorna lista de jugadores que fueron expulsados al menos una vez
        /// </summary>
        /// <returns></returns>
        public List<Jugador> GetJugadoresExpulsados()
        {
            ...
            foreach (Partido p in Partidos)
            {
                foreach (Incidencia i in p.GetIncidencias())
                {
                    ...
                    {
                        i.UnJugador.FueExpulsado = true;
                        if (!jugadoresExpulsados.Contains(i.UnJugador))
                        {
                            jugadoresExpulsados.Add(i.UnJugador);
                        }
                    }
                }
            }
        ...
        /// <summary>
        /// Retorna el partido con mas goles de una determinada seleccion pasada por parametro
        /// </summary>
        /// <param name="unaSeleccion"></param>
        /// <returns></returns>
        public List<Partido> PartidoConMasGoles(Seleccion unaSeleccion)
        {
            List<Partido> listaPartidosGoleados = new List<Partido>();
            Partido partidoGoleado = null;
            int contador = 0;


            foreach (Partido unPartido in Partidos)
            {
                if (unPartido.Seleccion1 == unaSeleccion || unPartido.Seleccion2 == unaSeleccion)
                {
                    if (contador == 0)
                    {
                        partidoGoleado = unPartido;
                        listaPartidosGoleados.Add(partidoGoleado);
                        contador++;
                    }
                    else 
                    {
                        if (unPartido.GetGoles() > partidoGoleado.GetGoles())
                        {
                            listaPartidosGoleados.Clear();
                            partidoGoleado = unPartido;
                            listaPartidosGoleados.Add(partidoGoleado);
                        }
                        else if (unPartido.GetGoles() == partidoGoleado.GetGoles())
                        {
                            listaPartidosGoleados.Add(unPartido);
                        }
                    }
            ...
            return listaPartidosGoleados;
        }

        /// <summary>
        /// Retorna la lista de partidos de un jugador pasando su id por parametro
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public List<Partido> ListaDePartidosJugador(int id)
        {
            ValidarId(id);
            ...
            foreach (Partido p in Partidos)
            {
                foreach (Jugador j1 in p.Seleccion1.GetJugadores())
                {
                    if (j1.Id == id)
                    {
                ...
                foreach (Jugador j2 in p.Seleccion2.GetJugadores())
                {
                    if (j2.Id == id)
                    {
                        listaDePartidos.Add(p);
        ...
        /// <summary>
        /// Valida que el Id ingresado por parametro corresponda a algun jugador de la lista
        /// </summary>
        /// <param name="id"></param>
        public void ValidarId(int id) 
        {
            bool existe = false;
            foreach (Jugador juga in Jugadores)
            {
                if (juga.Id == id)
                {
                    existe = true;
            ...
            if (!existe)
            {
                throw new Exception("El Id no pertenece a ningun jugador");
            }
        }
        ...
        /// <summary>
        /// Retorna lista de jugadores con al menos 1 gol
        /// </summary>
        /// <returns></returns>
        public List<Jugador> JugadorConUnGol(int id)
        {
            List<Jugador> jugadoresConUnGol = new List<Jugador>();

            foreach (Partido partido in Partidos)
            {
                if (partido.Id == id)
                {
                    foreach (Incidencia i in partido.GetIncidencias())
                    {
                        if (i.TipoIncidencia == "Gol" && i.Minuto != -1)
                        {
                            if (!jugadoresConUnGol.Contains(i.UnJugador))
                            {
                                jugadoresConUnGol.Add(i.UnJugador);
                            }
                        }
                    }
                }
            }
            return jugadoresConUnGol;
        }

        /// <summary>
        /// Metodo que cambia el monto de referencia para saber si los jugadores son VIP o Estandar
        /// </summary>
        /// <param name="monto"></param>
        public void cambiarMontoEstandar(string valor)
        {
            bool exito = double.TryParse(valor, out double monto);

            if (exito == true)
            {
                if (monto >= 0)
                {
                    Jugador.MontoEstandar = monto;
                    foreach (Jugador j in Jugadores)
                    {
                        j.TipoCategoriaFinanciera = j.VerCategoriaFinanciera();
                    }
                }
                else
                {
                    throw new Exception("Ingrese el monto en numeros enteros positivos");
                }
            }
            else
            {
                throw new Exception("Ingrese un valor numérico");
            }
        ...
        /// <summary>
        /// Devuelve un partido si coincide id por parametro
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public Partido getPartidoPorSuId(int id)
        {
            foreach (Partido p in Partidos)
            {
                if (p.Id == id)
        ...
        /// <summary>
        /// Devuelve el usuario si coincide el email y la contraseña
        /// </summary>
        /// <param name="emailUsuario"></param>
        /// <param name="passwordUsuario"></param>
        /// <returns></returns>
        public Usuario LogueoUsuario(string emailUsuario, string passwordUsuario)
        {
            foreach (Usuario u in Usuarios)
            {
                if (u.Email.Equals(emailUsuario) && u.Password.Equals(passwordUsuario))
                {
                    return u;
                }
            }
        ...
        /// <summary>
        /// Devuelve un usuario a partir de un id como parametro
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Devuelve un partido a partir de un id como parametro
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Finaliza un partido que pasamos por parametro
        /// </summary>
        /// <param name="p"></param>
        ...
        /// <summary>
        /// Devuelve la lista de periodistas
        /// </summary>
        /// <returns></returns>
        public List<Periodista> GetPeriodistas() 
        {
            List<Periodista> listaPer = new List<Periodista>();

            foreach (Usuario usuario in Usuarios)
            {
                if (usuario.GetTipo() == "Periodista")
                {
                    Periodista aux = usuario as Periodista; 
                    listaPer.Add(aux);
                }
            }
            listaPer.Sort();
        ...
        /// <summary>
        /// Devuelve un partido de Eliminatoria si coincide el id pasado por parametro
        /// </summary>
        /// <param name="idPartido"></param>
        /// <returns></returns>
        public FaseEliminatoria GetEliminatoria(int idPartido) 
        {
            foreach (Partido p in Partidos)
            {
                if (idPartido == p.Id)
                {
                    if (p.GetTipo() == "Eliminatoria")
                    {
                        return p as FaseEliminatoria;
                    }
                    else
                    {
                        return null;
        ...
        /// <summary>
        /// Devuelve un partido de fase de grupos si coincide el id pasado por parametro
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public FaseDeGrupos GetGrupos(int id)
        {
            foreach (Partido p in Partidos)
            {
                if (id == p.Id)
        ...
        /// <summary>
        /// Devuelve la/s seleccion/es con mas goles
        /// </summary>
        /// <returns></returns>
        public List<Seleccion> SeleccionConMasGoles()
        {
            List<Seleccion> SeleccionGoleadora = new List<Seleccion>();
            int goles = 0;
            int goleadores = -1;
            foreach (Seleccion s in Selecciones)
            {
                foreach (Partido p in Partidos)
                {
                    if (p.Seleccion1 == s || p.Seleccion2 == s)
                    {
                        foreach (Incidencia i in p.GetIncidencias())
                        {
                ...
                if (goles > goleadores)
                {
                    goleadores = goles;
                    goles = 0;
                    SeleccionGoleadora.Clear();
                    SeleccionGoleadora.Add(s);
                }
                else if (goles == goleadores)
                {
                    goles = 0;
                    SeleccionGoleadora.Add(s);
                }
            ...
            return SeleccionGoleadora;

        }

        /// <summary>
        /// Devuelve las reseñas de un periodista en los partidos que hubo una tarjeta roja
        /// </summary>
        /// <param name="email"></param>
        /// <returns></returns>
        public List<Resenia> GetReseniaPeriodistas(string email)
        {
            List<Resenia> listaRes = new List<Resenia>();
            int contador = 0;
            foreach (Resenia resenia in Resenias)
            {
                if (resenia.UnPeriodista.Email == email)
                {
                    foreach (Incidencia i in resenia.UnPartido.GetIncidencias())
                    {
                        if (i.TipoIncidencia == "Roja")
                        {
                            contador++;
        ...
        /// <summary>
        /// Devuelve las reseñas de un periodista por su id
        /// </summary>
        /// <param name="email"></param>
        /// <returns></returns>
        public List<Resenia> GetReseniasUnPeriodista(int id)
        {
            List<Resenia> listaRes = new List<Resenia>();

            foreach (Resenia resenia in Resenias)
            {
                if (resenia.UnPeriodista.Id == id)
                {
                    listaRes.Add(resenia);
                }
            }
        ...
        /// <summary>
        /// Devuelve el usuario que coincida con el email pasado por parametro
        /// </summary>
        /// <param name="email"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Devuelve los partidos entre dos fechas
        /// </summary>
        /// <param name="fecha1"></param>
        /// <param name="fecha2"></param>
        /// <returns></returns>
        public List<Partido> GetPartidos(DateTime fecha1, DateTime fecha2)
        {
            ...
            foreach (Partido p in Partidos)
            {
                ...
                {
                    if ((p.FechaYhoraDelPartido > fecha1 && p.FechaYhoraDelPartido < fecha2) || (p.FechaYhoraDelPartido > fecha2 && p.FechaYhoraDelPartido < fecha1))
                    {
                        lista.Add(p);
                    }
                }
        ...
        /// <summary>
        /// Metodo que verifica si no existen partidos finalizados
        /// </summary>
        /// <returns></returns>
        public int PartidosFinalizados()
        {
            foreach (Partido partido in Partidos)
            {
        ...
        /// <summary>
        /// Devuelve true si el periodista tiene alguna reseña
        /// </summary>
        /// <param name="p"></param>
        /// <returns></returns>
        public bool ListaVaciaPeriodista(Periodista p)
        {
            int contador = 0;

            foreach (Resenia r in Resenias)
            {
                if (r.UnPeriodista.Equals(p))
                {
                    contador++;
                }
            }
